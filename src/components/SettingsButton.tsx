...
export default function SettingsButton({ onClick }: { onClick: () => void }) {
    ...
    return (
        <button
            ...
            title="Paramètres"
            onClick={onClick}
            style={{ position: 'fixed', right: 12, bottom, zIndex: 10000, width: 44, height: 44, borderRadius: '50%', border: '1px solid #ddd', background: 'white', boxShadow: '0 2px 8px rgba(0,0,0,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20 }}
        >
            ⚙
        </button>
    )
