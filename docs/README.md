...
**👉 [Allez à START_HERE.md](./START_HERE.md) - Navigation rapide vers le bon guide**

ou lancez directement :

```bash
npm install && cd backend && npm install && npm run prisma:migrate:dev
npm run dev  # Terminal 1 - Frontend sur http://localhost:5173
cd backend && npm run dev  # Terminal 2 - Backend sur http://localhost:3001
```

**📖 Guides détaillés :** [QUICK_START.md](./QUICK_START.md)
...
| Document | Description |
|----------|-------------|
| **[QUICK_START.md](./QUICK_START.md)** | ⚡ Démarrage très rapide (5 min) |
| **[PROJECT_STRUCTURE.md](./PROJECT_STRUCTURE.md)** | 🗂️ Structure du projet expliquée |
| **[DEPLOYMENT_GUIDE.md](./DEPLOYMENT_GUIDE.md)** | 🚀 Guide complet déploiement (Vercel + Render) |
